...
const _n8nPass = process.env.N8N_ADMIN_PASS || (() => { console.error('ERROR: N8N_ADMIN_PASS not set'); process.exit(1); })();
api('POST','/rest/login',{email:'snjagi@i3technologies.co.ke',password:_n8nPass},null,(s,h)=>{
